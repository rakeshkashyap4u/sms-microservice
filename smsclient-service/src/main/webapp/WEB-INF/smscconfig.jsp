...
<form method="post" modelAttribute="config" action="<%= request.getContextPath() %>/updateSmscConfig">
    <div class="section"><span>2</span>SMSC IP Configuration &amp; </div>
    <div class="inner-wrap">
       <!--  <label>circle ID<input type="text" name="cid" /></label> -->
        <label>Operator Id <input type="text" name="opId" /></label>
        ...
        <label>Bind Mode <input type="text" name="bindMode" /></label>
      </div>
